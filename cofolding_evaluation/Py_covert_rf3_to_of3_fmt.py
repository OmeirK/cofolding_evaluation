...
parser.add_argument('--rf3_dir', '-rd', help='Protenix results directory')
...
def main():
    case_list = os.listdir(args.rf3_dir)
    ...
    for case in case_list:
        seed_list = os.listdir(f'{args.rf3_dir}/{case}/')
        
        for seed in seed_list:
            print(case, seed)
            case_outdir = f'{args.out_dir}/{case}/{seed}/'
            os.makedirs(case_outdir, exist_ok=True)
            output_files = glob.glob(f'{args.rf3_dir}/{case}/{seed}/{case}/*/*')
